...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p dd443631-0bef-4df9-953a-34ae7bffcbac
```

> `dd443631-0bef-4df9-953a-34ae7bffcbac` is the password of the certificate, you can change it to any password you want.
